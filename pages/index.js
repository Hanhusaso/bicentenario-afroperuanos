								...
								<div>
									<div className="mb-5">
										<p>
											...
											deserunt magni rem libero, quod at nihil tempore debitis, architecto odit aut
											modi reiciendis fuga iusto aperiam temporibus? Ut, esse. Maiores aut debitis
											corrupti repellendus soluta deserunt, quaerat fugiat rem vero aliquid
											aspernatur placeat impedit deleniti tempore ullam beatae nostrum aperiam,
											laborum repellat, sint praesentium? Debitis quibusdam nisi tenetur delectus.
										</p>
									</div>
								...
								<div className={`${styles.grid}`}>
									<div className="pt-4">
										<div className="mb-5">
											...
											<div>
												<p>
													Explora y disfruta la exposición desde sus ejes temáticos n vulputate
													velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis
													at vero eros et accumsan et iust
												</p>
											</div>
										</div>
										<div className="mb-5">
						...
						<div className={`${styles.containerGrid} ${"containerGrid"}`}>
							...
							<div className="d-flex align-items-center">
								<div>
									...
									<div className="mb-5">
										<img
											className="underline-arrows"
											src="/img/svg/flechas_blancas(25).svg"
											alt=""
										/>
									</div>
									<div>
										Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi alias sapiente,
										incidunt vitae laboriosam reprehenderit! Repellat alias sit deserunt porro nam,
										voluptates odio! Vel quaerat rem error laboriosam quis assumenda. Ullam eaque,
										illo magnam facilis cum officia! Aliquam, esse. Animi dignissimos expedita
										laborum rem repellat voluptatibus labore neque maxime ex perferendis, quasi
										corporis nulla molestiae cum magni porro tempora consequuntur! Et dolore, labore
										culpa quas perspiciatis voluptatum harum soluta fuga porro dicta id consectetur
										laboriosam, inventore, quam eaque? Vel quod quibusdam libero quos? Dicta enim
										expedita, cumque libero ea suscipit. Totam sequi hic quisquam, unde minus nam
										impedit. Optio maxime porro dicta magnam natus quasi, voluptatem nihil
										exercitationem. Eligendi esse inventore debitis vitae delectus sit nostrum quos
										omnis amet corrupti! Eum quae ea consequuntur officiis quia tenetur eius esse ad
										placeat temporibus veritatis reprehenderit dolores, id molestiae odio dolorum
										dolorem dolor alias, voluptatem hic maxime. Officiis, repellat voluptatum. Nemo,
										vitae? Sunt, nostrum consectetur vero deleniti inventore repellendus repudiandae
										tenetur corrupti deserunt eum sapiente reprehenderit amet sequi ipsam! In, error
										numquam delectus dolores temporibus praesentium ea dicta obcaecati, ducimus
										accusantium doloribus! Impedit, alias fugit. Velit nemo dolore consequuntur
										ipsam eum, ullam voluptates, necessitatibus fuga a tempore ipsa provident minima
										quas, laboriosam sed pariatur accusamus vitae. Ullam pariatur molestias minus
										voluptate velit. Corrupti, odit sed consectetur nemo perferendis voluptatibus
										ullam illo ratione exercitationem nulla, fugiat recusandae quisquam labore iusto
										est suscipit voluptatum eaque impedit cupiditate hic. Hic rerum aut delectus
					...
					<Element className="h-100" name="actividadesParalelas">
						<div className={`${styles.containerGrid} ${"containerGrid"}`}>
							<div className="">
								<LinkScroll
									activeClass="active"
									className={`${styles.linkMenu} ${"pointer d-flex align-items-center"}`}
									to="menuPrincipal"
									smooth={true}
									duration={200}
								>
									...
									<div className={`${styles.video1} ${"wrapperVideo mb-5"}`}>
										...
										<div className={`${styles.infoVideo} ${"infoVideo"}`}>
											...
											<div className={`${styles.titulo} ${"titulo"}`}>
												Conferencia de Maribel Arrelucea - “Título im ad minim veniam, quis nostrud
												exerci t”
											</div>
											<div className="descripcion">
												Lorem ipsum dolor sit amet consectetur adipisicing elit. Est fugiat ducimus
												doloribus nesciunt sed corporis, laudantium vel distinctio incidunt labore
												quam in tempore ipsum dolorem dolores, explicabo voluptatem deserunt
												possimus!
											</div>
										</div>
									</div>
